...
```{r func, comment="", echo=FALSE, message=FALSE, warning=FALSE}
#Genome functions
genome_annotations <- read_tsv("resources/DMB0032_annotations.tsv")
```
...
```{r}
save(read_counts, read_counts_coverage, genome_counts, tree, genome_metadata, kegg_table, sample_metadata, file = "resources/data/data.Rdata") #genome_gifts,genome_annotations
```
