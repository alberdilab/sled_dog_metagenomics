...
colNames <- names(element_gift_names)[2:87] # change to change number of plotted elements
for(i in colNames){
...
colNames <- names(function_gift_names)[2:13] # change to change number of plotted functions
for(i in colNames){
